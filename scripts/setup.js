...
inquirer
	...
	.then(({ spaceId, managementToken }) => spaceImport({ spaceId, managementToken, content: data }))
	.then((_, error) => {
		console.log(`All set! You can now run ${chalk.yellow('yarn start')} to see it in action.`);
	})
