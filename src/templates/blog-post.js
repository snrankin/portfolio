...
import { Container, Flex, Box, Space, Heading, Text, Avatar } from '../components/ui';
		...
		<Layout>
			<Container>
				<Box paddingY={5}>
							...
							<Flex>
								{props.author.avatar &&
									(props.author.avatar.gatsbyImageData ? (
										<Avatar {...props.author.avatar} image={props.author.avatar.gatsbyImageData} />
									) : (
										<img
					...
					<Space size={4} />
					{props.image && <GatsbyImage alt={props.image.alt} image={props.image.gatsbyImageData} />}
					<Space size={5} />
					<div
