	...
	return (
		...
		>
			<SkillsList
				...
				langClass="shadow lg:col-span-4 text-slate-950 bg-primary-500 dark:bg-primary-600"
				cmsClass="shadow lg:col-span-4 text-slate-100 bg-accent-500 dark:bg-accent-600"
				frameClass="shadow lg:col-span-4 text-slate-950 bg-secondary-500 dark:bg-secondary-600"
				toolClass="shadow lg:col-span-6 text-slate-950 bg-warning-500 dark:bg-warning-600"
				softClass="shadow md:col-span-2 lg:col-span-6 text-slate-950 bg-success-500 dark:bg-success-600"
				groupProps={{
					compact: true,
					showGroupTitle: true,
