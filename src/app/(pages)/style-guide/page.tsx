			...
			<Section>
				<div className="prose">
					...
					<p>
						...
						styling from paragraphs, headings, lists and more. This
						ends up being really useful for building application UIs
						because you spend less time undoing user-agent styles,
						but when you <em>really are</em> just trying to style
						some content that came from a rich-text editor in a CMS
						or a markdown file, it can be surprising and
						unintuitive.
					</p>{' '}
					<p>
					...
					<blockquote>
						<p>
							...
							<code>h1</code> elements? How do I disable this?
							What do you mean I lose all the other base styles
							too?
						</p>
					</blockquote>{' '}
					<p>
						We hear you, but we’re not convinced that simply
						disabling our base styles is what you really want. You
						don’t want to have to remove annoying margins every time
						you use a <code>p</code> element in a piece of your
						dashboard UI. And I doubt you really want your blog
						posts to use the user-agent styles either — you want
						them to look <em>awesome</em>, not awful.
					</p>{' '}
					<p>
						The <code>@tailwindcss/typography</code> plugin is our
						attempt to give you what you <em>actually</em> want,
						without any of the downsides of doing something stupid
						like disabling our base styles.
					</p>{' '}
					<p>
						It adds a new <code>prose</code> class that you can slap
					...
					<p>
						...
						nonsense I’ve written to dogfood the plugin itself. It
						includes every sensible typographic element I could
						think of, like <strong>bold text</strong>, unordered
					...
					<ol>
						...
						<li>
							Really just the first reason, that’s the whole point
							of the plugin.
						</li>{' '}
						<li>
							Here’s a third pretend reason though a list with
							three items looks more realistic than a list with
							two items.
						</li>
					</ol>{' '}
					...
					<p>
						Something a wise person once told me about typography
						is:
					</p>{' '}
					<blockquote>
						<p>
							Typography is pretty important if you don’t want
							your stuff to look like trash. Make it good then it
							won’t be bad.
						</p>
					</blockquote>{' '}
					<p>
					...
					<p>
						...
						margin on the second heading because it usually looks
						better for the headings to be closer together than a
					...
					<p>
						When a heading comes after a paragraph, we need a bit
						more space, like I already mentioned above. Now let’s
					...
					<ul>
						<li>
							...
							<p>
								...
								unfortunate because it’s pretty annoying to get
								the styles right.
							</p>{' '}
							<p>
								I often have two or three paragraphs in these
								list items, too, so the hard part is getting the
								spacing between the paragraphs, list item
								heading, and separate list items to all make
								sense. Pretty tough honestly, you could make a
								strong argument that you just shouldn’t write
								this way.
							</p>
						</li>{' '}
						<li>
							...
							<p>
								...
								list if it only had one item, and we really want
								this to look realistic. That’s why I’ve added
								this second list item so I actually have
						...
						<li>
							...
							<p>
								I think it probably would’ve been fine to just
								use two items but three is definitely not worse,
								and since I seem to be having no trouble making
								up arbitrary things to type, I might as well
								include it.
							</p>
						</li>
					</ul>{' '}
					...
					<p>
						...
						or something if they want to style their code blocks but
						it wouldn’t hurt to make them look <em>okay</em> out of
						the box, even with no syntax highlighting.
					</p>{' '}
					<p>
						Here’s what a default <code>tailwind.config.js</code>{' '}
					...
					<pre className="language-js">
						<code className="language-js">
							module
							<span className="token punctuation">.</span>
							exports <span className="token operator">
								=
							</span>{' '}
							<span className="token punctuation">{'{'}</span>
							{'\n'}
					...
					<p>
						...
						guess since some of you goofballs are going to do it we
						have to carry the burden of at least making it work.
					</p>{' '}
					<ol>
						<li>
							<strong>
							...
							<ul>
								...
								<li>
									Nested navigation in UIs is a bad idea too,
									keep things as flat as possible.
								</li>{' '}
								<li>
									Nesting tons of folders in your source code
									is also not helpful.
								</li>
							</ul>
						</li>{' '}
						<li>
							...
							<ul>
								<li>
									I’m not sure if we’ll bother styling more
									than two levels deep.
								</li>{' '}
								<li>
									Two is already too much, three is guaranteed
									to be a bad idea.
								</li>{' '}
								<li>
						...
						<li>
							...
							<ul>
								<li>
									...
									people to actually read your content.
								</li>{' '}
					...
					<p>
						...
						<code>&lt;p&gt;</code> tag unless there are multiple
					...
					<ul>
						...
						<li>
							...
							<ul>
								<li>
									<p>
										As you can see here, because I’ve added
										a second line, this list item now has a{' '}
										<code>&lt;p&gt;</code> tag.
									</p>{' '}
									<p>
					...
					<p>
						...
						. We almost made them blue but that’s so yesterday, so
						we went with dark gray, feels edgier.
					</p>{' '}
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td>Austin, TX</td> <td>Stone Cold Stunner</td>
							</tr>{' '}
							<tr>
					...
					<p>
						We also need to make sure inline code looks good, like
						if I wanted to talk about <code>&lt;span&gt;</code>{' '}
					...
					<p>
						...
						<code>code</code> tag inside of a link, like if I wanted
						...
						below the backticks but it is absolutely not worth the
					...
					<p>
						...
						<code>h6</code> in your content, Medium only supports
						two heading levels for a reason, you animals. I honestly
						considered using a <code>before</code> pseudo-element to
						scream at you if you use an <code>h5</code> or{' '}
						<code>h6</code>.
					</p>{' '}
					<p>
						We don’t style them at all out of the box because{' '}
						<code>h4</code> elements are already so small that they
						are the same size as the body copy. What are we supposed
						to do with an <code>h5</code>, make it <em>smaller</em>{' '}
					...
					<p>
						Phew, with any luck we have styled the headings above
						this text and they look pretty good.
					</p>{' '}
					<p>
						Let’s add a closing paragraph here so things end with a
						decently sized block of text. I can’t explain why I want
						things to end that way but I have to assume it’s because
						I think things will look weird or unbalanced if there is
						a heading too close to the end of the document.
					</p>{' '}
					<p>
