...
import { Container, Section, FlexList, Text, Kicker, Heading, Flex, Box, Icon, ButtonList, Nudge } from './ui';
		...
		<Container width="fullbleed">
			<Section padding={5} radius="large" background="primary">
				<Flex responsive variant="end">
					<Box width="half">
						{props.icon && <Icon alt={props.icon.alt} image={props.icon.gatsbyImageData} />}
						<Heading>
					...
					<Box width="half">
						{props.image && (
							<Nudge right={5} bottom={5}>
								<GatsbyImage alt={props.image.alt} image={getImage(props.image.gatsbyImageData)} />
							</Nudge>
						)}
					</Box>
				</Flex>
