...
import { Container, FlexList, Heading, Section, Text, Box, Kicker, Space } from './ui';

function AboutProfile(props) {
	return (
		<Box width="third" padding={4} center>
			{props.image && <GatsbyImage alt={props.image.alt} image={getImage(props.image.gatsbyImageData)} />}
			<Space size={3} />
			<Box>
				{props.name && (
