...
export default function NavItemGroup({ name, navItems }) {
	...
	return (
		<Flex data-id={`${name}-group-wrapper`} variant="columnStart" gap={4} className={styles.navGroupWrapper}>
			<NavButtonLink onClick={onGroupButtonClick} className={styles.navGroupTitle}>
			...
			{isOpen && (
				<Box
					...
					className={styles.navLinkListWrapper[popupVisible ? 'opened' : 'closed']}
				>
					<FlexList variant="columnStart" gap={2} className={styles.navLinkListWrapperInner}>
