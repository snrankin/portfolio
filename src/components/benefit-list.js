...
import { Container, Section, FlexList, Box, Icon, Heading, Text, Space } from './ui';

function Benefit(props) {
	return (
		<Box as="li" width="third" padding={4} paddingY={3}>
			{props.image && <Icon alt={props.image.alt} image={props.image.gatsbyImageData} size="small" />}
			<Space size={2} />
