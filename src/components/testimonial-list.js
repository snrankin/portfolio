...
import { Container, Section, Heading, Kicker, Flex, Box, FlexList, Blockquote, Text, Avatar } from './ui';

function Testimonial(props) {
	return (
		<Flex variant="start">
			{props.avatar && <Avatar alt={props.avatar.alt} image={props.avatar.gatsbyImageData} />}
			<Blockquote>
