...
exports.createSchemaCustomization = async ({ actions }) => {
	...
	actions.createTypes(/* GraphQL */ `
		...
		type ContentfulNavItem implements Node & NavItem & HeaderNavItem @dontInfer {
			id: ID!
		...
		type ContentfulNavItemGroup implements Node & NavItemGroup & HeaderNavItem @dontInfer {
			id: ID!
